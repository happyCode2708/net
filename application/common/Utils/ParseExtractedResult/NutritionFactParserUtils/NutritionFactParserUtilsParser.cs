...
namespace MyApi.Application.Common.Utils.ParseExtractedResult.NutritionFactParserUtils
{
    public class NutritionFactParserUtils
    {
        public static NutritionFactData ParseMarkdownResponse(string markdownResponse)
        {
            ...
            {
                FactPanelsData = new List<FactPanels>()
            };
            ...
            foreach (var section in sections)
            {
                ...
                if (section.Contains("NUTRITION_FACT_TABLE"))
                {
                    ...
                    // Cần khởi tạo FactPanels mới cho mỗi panel index
                    while (result.FactPanelsData.Count <= panelIndex)
                    {
                        result.FactPanelsData.Add(new FactPanels
                        {
                    ...
                    foreach (var line in lines)
                    {
                        ...
                        {
                            result.FactPanelsData[panelIndex].Nutrients.Add(new Nutrient
                            {
                ...
                if (section.Contains("HEADER_TABLE"))
                {
                    ...
                    if (headerLine != null)
                    {
                        ...
                        if (parts.Length >= 5)
                        {
                            result.FactPanelsData[panelIndex].Header = new HeaderInfo
                            {
                ...
                if (section.Contains("FOOTNOTE_TABLE"))
                {
                    ...
                    foreach (var line in lines)
                    {
                        ...
                        {
                            result.FactPanelsData[panelIndex].Footnotes.Add(footnote);
                        }
                    }
                }
            }
        ...
        public static int getIndexFromSection(string section)
        {
